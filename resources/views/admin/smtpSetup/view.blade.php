    ...
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
            <h4 class="card-title">{{$title}} 
                @if(!empty($totalEmailSetup))
                    <span class="badge bg-primary">
                        {{count($totalEmailSetup)}}
                    </span>
                @endif
            </h4>
       </div>
       <a href="{{url('smtp-setup/create')}}">
            ...
            <table class="table table-striped mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex ">
                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" title="Edit" href="{{url('smtp-setup/edit/'.$val->id)}}" role="button">
                                ...
                                <a class="btn btn-danger btn-icon btn-sm rounded-pill ms-2" title="Delete" href="{{url('smtp-setup/delete/'.$val->id)}}" role="button">
                                    <span class="btn-inner">
