    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('smtp-setup/update/'.$list->id)}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <label class="form-label" for="plan">From Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="name" value="{{$list->name}}" autocomplete="off" required>
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="email" class="form-control" name="from_address" value="{{$list->from_address}}" autocomplete="off" required>
