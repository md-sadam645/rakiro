...
<main class="main-content">
   ...
   <!--Nav Start-->
                ...
                <div class="logo-main">
                    <div class="logo-normal">
                        <svg class="text-primary icon-30" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.25333 2H22.0444L29.7244 15.2103L22.0444 28.1333H7.25333L0 15.2103L7.25333 2ZM11.2356 9.32316H18.0622L21.3334 15.2103L18.0622 20.9539H11.2356L8.10669 15.2103L11.2356 9.32316Z" fill="currentColor"></path>
                  ...
                  <!--logo End-->     
                  <h4 class="logo-title d-block d-xl-none" data-setting="">Rakiro</h4>
             </a>
           
             <div class="d-flex align-items-center justify-content-between product-offcanvas">
                <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                   <small class="mb-0 text-capitalize" style="font-size:16px">{{$title}}</small>
                </div>
                <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive on-rtl end" tabindex="-1" id="offcanvasBottom">
                   <div class="offcanvas-body">
                        <ul class="iq-nav-menu list-unstyled">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow " data-bs-toggle="collapse" href="#home" role="button" aria-expanded="false" aria-controls="specialPages">
                                    Home
                                    <i class="right-icon">
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="home">
                                    <li class="nav-item"><a class="nav-link " href="{{route(('dashboard'))}}">Dashboard</a></li>
                                 </ul>
                              </li>
                              ...
                              <!--Start - Create List-->
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#create-list" role="button" aria-expanded="false" aria-controls="utilities">
                                    Create List
                                    <i class="right-icon">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="create-list">
                                    <li class="nav-item"><a class="nav-link " href="{{url('create-list/create')}}">Create</a></li>
                                    <li class="nav-item"><a class="nav-link " href="{{url('create-list/view')}}">View</a></li>
                                    <li class="nav-item"><a class="nav-link " href="{{url('create-list/detail')}}">Detail</a></li>
                                 </ul>
                              </li>
                              <!--End - Create List-->
                              ...
                              <!--Start - Email Compose-->
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#email-compose" role="button" aria-expanded="false" aria-controls="utilities">
                                    Email Message
                                    <i class="right-icon">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="email-compose">
                                    <li class="nav-item"><a class="nav-link " href="{{url('email-compose/create')}}">Create</a></li>
                                    <li class="nav-item"><a class="nav-link " href="{{url('email-compose/view')}}">Schedule</a></li>
                                 </ul>
                              </li>
                             <!--End - Email Compose-->
                              ...
                              <!--Start - Automation-->
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#automation" role="button" aria-expanded="false" aria-controls="utilities">
                                    Automation
                                    <i class="right-icon">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="automation">
                                    <li class="nav-item"><a class="nav-link " href="{{url('automail/create')}}">Create</a></li>
                                    <li class="nav-item"><a class="nav-link " href="{{url('automail/view')}}">View</a></li>
                                 </ul>
                              </li>
                             <!--End - Automation -->
                              ...
                              <!--start SubAdmin-->
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#sub-admin" role="button" aria-expanded="false" aria-controls="utilities">
                                    Sub Admin
                                    <i class="right-icon">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="sub-admin">
                                    <li class="nav-item"><a class="nav-link " href="{{url('sub-admin/create')}}">Create</a></li>
                                    <li class="nav-item"><a class="nav-link " href="{{url('sub-admin/view')}}">View</a></li>
                              ...
                              <!--Start - smtp setup-->
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#smtp-setup" role="button" aria-expanded="false" aria-controls="utilities">
                                    Smtp Setup
                                    <i class="right-icon">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="smtp-setup">
                                    <li class="nav-item"><a class="nav-link " href="{{url('smtp-setup/create')}}">Create</a></li>
                                    <li class="nav-item"><a class="nav-link " href="{{url('smtp-setup/view')}}">View</a></li>
                                 </ul>
                              </li>
                              <!--End - smtp setup-->
                              ...
                              <!--Start - common setup-->
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#common-setup" role="button" aria-expanded="false" aria-controls="utilities">
                                    Common Setup
                                    <i class="right-icon">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="common-setup">
                                    <li class="nav-item"><a class="nav-link " href="{{url('common-setup/create')}}">Create</a></li>
                                 </ul>
                              </li>
                              <!--End - common setup-->
                              @endif
                    ...
                    <li class="nav-item iq-full-screen d-none  d-xl-block border-end" id="fullscreen-item">
                     ...
                     <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                           <img  @if(!empty(Auth::user()->photo)) src="{{url(Auth::user()->photo)}}"  @else src="{{url('images/avtaar/avtaar.jpg')}}" @endif alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                           <div class="caption ms-3 d-none d-md-block ">
                              <h6 class="mb-0 caption-title text-capitalize">{{Auth::user()->name}}</h6>
                              <p class="mb-0 caption-sub-title">@if(Auth::user()->role == 1) Admin @else SubAdmin @endif</p>
                           </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                           <li><a class="dropdown-item" href="{{url('profile/view')}}"><i class="fa-solid fa-user"></i> &nbsp; Profile</a></li>
                           <li><hr class="dropdown-divider"></li>
                           <li><a class="dropdown-item" href="{{url('change-password')}}"><i class="fa-solid fa-lock"></i> &nbsp; Change Password</a></li>
                           <li><hr class="dropdown-divider"></li>
                           <li><a class="dropdown-item" href="{{url('logout_admin')}}"><i class="fa-solid fa-right-from-bracket"></i> &nbsp; Logout</a></li>
                        </ul>
                     </li>
                </ul>
             </div>
       ...
       <!-- Nav Header Component Start -->
         <div class="iq-navbar-header " style="height: 150px;color:#fff;background:url({{url('assets/backend/images/dashboard/top-header.png')}})">
