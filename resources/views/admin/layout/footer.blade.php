    ...
    <footer class="footer">
        <div class="footer-body d-flex justify-content-center">
            ...
            <div class="right-panel">
                ©{{date('Y')}} <span data-setting="">Rakiro</span>, Made with
...
<script src="{{asset('assets/backend/js/core/libs.min.js')}}"></script>
<!-- Plugin Scripts -->
<!-- Tour plugin Start -->
<script src="{{asset('assets/backend/vendor/sheperd/dist/js/sheperd.min.js')}}"></script>
<script src="{{asset('assets/backend/js/plugins/tour.js')}}" defer></script>
...
<script src="{{asset('assets/backend/vendor/flatpickr/dist/flatpickr.min.js')}}"></script>
<script src="{{asset('assets/backend/js/plugins/flatpickr.js')}}" defer></script>



  <!-- Select2 Script -->
  {{-- <script src="{{asset('assets/backend/js/plugins/select2.js')}}" defer></script> --}}




<!-- Slider-tab Script -->
<script src="{{asset('assets/backend/js/plugins/slider-tabs.js')}}"></script>

<!-- SwiperSlider Script -->
<script src="{{asset('assets/backend/vendor/swiperSlider/swiper-bundle.min.js')}}"></script>
<script src="{{asset('assets/backend/js/plugins/swiper-slider.js')}}" defer></script>
<!-- Lodash Utility -->
...
<!-- Settings Init Script -->
<script src="{{asset('assets/backend/js/create_list.js')}}"></script>
