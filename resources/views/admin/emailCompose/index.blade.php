                        ...
                        <div class="modal-dialog m-0 me-md-4 mb-4">
                            <div class="modal-content w-100 p-0">
                                <div class="modal-body w-100 flex-grow-1 pb-sm-0 p-4 py-4">
                                    <form class="email-compose-form" method="POST" action="/emailCompose" enctype="multipart/form-data">
                                        @csrf
                                        <div class="email-compose-cc mb-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <select class="form-control shadow-none flex-grow-1 ms-2 from-email" name="email_from" required>
                                                    <option value="choose from email">Choose From Email</option>
                                                    @if($smtp != '[]')
                                                        @foreach ($smtp as $smtpData)
                                                            <option value="{{$smtpData->from_address}}" @if(session()->get("email_from") == $smtpData->from_address) selected @endif>{{$smtpData->from_address}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center col-md-12">
                                            ...
                                            <div class="w-100 border selectMultipleCon">
                                                @php 
                                                    $groupArray = json_decode(session()->get('email_to'));
                                                @endphp
                                        ...
                                        <hr class="container-m-nx my-2">
                                            ...
                                            @if(!empty(session()->get('email_cc')))
                                                @php
                                                    $explodeCc = session()->get('email_cc');
                                                @endphp
                                        ...
                                        <div class="email-compose-subject d-flex align-items-center mb-2">
                                            ...
                                            @if(!empty(session()->get("email_from"))) value="{{session()->get("email_subject")}}" @else placeholder="hello.." @endif >
                                        </div>
                                        ...
                                        <div class="email-compose-message mt-3" style="position:relative;">
                                            ...
                                            <textarea name="email_msg" class="mt-5" required> @if(!empty(session()->get("email_msg"))) {{session()->get("email_msg")}} @endif</textarea>
                                        ...
                                        <div class="email-compose-subject d-flex align-items-center mb-2">
                                            ...
                                            <div class="pt-2 me-3 ms-lg-2">
                                                ...
                                                <input type="text" name="no_attachment" id="attach-file" class="d-none old-file" readonly value="{{session()->get('attachment')}}" style="opacity:1 !important;">
                                            </div>
                                            <div class="position-relative" title="Delete File">
                                                @if(!empty(session()->get('attachment')))
                                                    <div style="position:absolute;right:-15px;cursor:pointer;" id="file-delete-btn" emailID="{{session()->get('attachment')}}" class="p-1 rounded-circle attch-dlt">
                                        ...
                                        <div class="mt-4 row">
                                            ...
                                            @if(!empty(session()->get("test_email")))
                                            <div class="col-md-12 col-lg-2">
                                                <a class="btn btn-primary schedule-btn" href="{{url('email-form-reset/1')}}">
                                        ...
                                        <div class="modal fade" id="sendTestMail" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title" id="staticBackdropLabel">Send Test Email</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col-md-12 col-12 mb-4">
                                                            ...
                                                            @if(!empty(session()->get("test_email"))) value="{{session()->get("test_email")}}" @else placeholder="Enter Email" @endif />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="col-md-12 col-12 mb-4">
                                                        ...
                                                        <input type="datetime-local" name="schedule_time" required class="form-control schedule_time" id="schedule-time" />
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
