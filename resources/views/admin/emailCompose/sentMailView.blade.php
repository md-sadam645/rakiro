                        ...
                        <td>
                            <div class="d-flex ">
                                ...
                                @if($val->sending_status == 1 && $val->status == 1)
                                    <a class="btn btn-warning btn-icon btn-sm rounded-pill ms-2" title="Stop Sending Email" href="/stop-sending-email/{{$val->id}}" role="button">
                                        <span class="btn-inner">
                                            <i class="fa-solid fa-circle-stop" style="font-size:17px;"></i>
                                        </span>
                                    </a>
                                {{-- @elseif($val->sending_status == 0 && $val->status == 1)
                                    <a class="btn btn-success btn-icon btn-sm rounded-pill ms-2" title="Start Sending Email" href="/start-sending-email/{{$val->id}}" role="button">
                                        <span class="btn-inner">
                                ...
                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2"  @if($val->status == 0 || $val->status == 1) title="Edit Scheduled Email" href="/email-compose/edit/{{$val->id}}" @else title="Mail sent, doesn't update scheduled Email" @endif role="button">
                                    <span class="btn-inner">
