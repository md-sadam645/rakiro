                        ...
                        <div class="modal-dialog m-0 me-md-4 mb-4">
                            <div class="modal-content w-100 p-0">
                                <div class="modal-body w-100 flex-grow-1 pb-sm-0 p-4 py-4">
                                    <form class="email-compose-form" method="POST" action="{{url('email-compose/duplicate-update/'.$list->id)}}" enctype="multipart/form-data">
                                        @csrf
                                                    ...
                                                    @if($smtp != '[]')
                                                        @foreach ($smtp as $smtpData)
                                                            <option value="{{$smtpData->from_address}}" 
                                                                @if(!empty(session()->get("duplicate_email_from")))
                                                                    @if(session()->get("duplicate_email_from") == $smtpData->from_address) selected @endif
                                                                @else
                                        ...
                                        <div class="d-flex align-items-center col-md-12">
                                            ...
                                            <div class="w-100 border selectMultipleCon">
                                                @php 
                                                    ...
                                                    $sessionGroupArray = json_decode(session()->get('duplicate_email_to'));
                                        ...
                                        <hr class="container-m-nx my-2">
                                            ...
                                            @if(!empty(session()->get('duplicate_email_cc')))
                                                @php
                                                    $sessionExplodeCc = session()->get('duplicate_email_cc');
                                                @endphp
                                        ...
                                        <div class="email-compose-subject d-flex align-items-center mb-2">
                                            ...
                                            value="@if(!empty(session()->get('duplicate_email_subject'))) {{session()->get('duplicate_email_subject')}} @else {{$list->subject}} @endif">
                                        </div>
                                        ...
                                        <div class="email-compose-message mt-3" style="position:relative;">
                                            ...
                                            <textarea name="email_msg" class="mt-5" required>
                                                @if(!empty(session()->get('duplicate_email_msg'))) {{session()->get('duplicate_email_msg')}} @else {{$list->message}} @endif
                                            </textarea>
                                        ...
                                        <div class="email-compose-subject d-flex align-items-center mb-2">
                                            ...
                                            <div class="pt-2 ms-lg-2 me-3">
                                                ...
                                                value="@if(!empty(session()->get('duplicate_attachment'))) {{session()->get('duplicate_attachment')}} @else {{$list->attachment}} @endif"
                                                style="opacity:1 !important;">
                                            </div>
                                            <div class="position-relative" title="Delete File">
                                                @if(!empty(session()->get('duplicate_attachment')))
                                                    <div style="position:absolute;right:-15px;cursor:pointer;" id="session-file-delete-btn" attachFile="{{session()->get('duplicate_attachment')}}" class="p-1 rounded-circle attch-dlt1">
                                        ...
                                        <div class="mt-5 row">
                                            ...
                                            @if(!empty(session()->get("duplicate_test_email")))
                                            <div class="col-md-12 col-lg-2">
                                                <a class="btn btn-primary schedule-btn" href="{{url('email-form-reset/3')}}">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col-md-12 col-12 mb-4">
                                                            ...
                                                            @if(!empty(session()->get("duplicate_test_email"))) value="{{session()->get("duplicate_test_email")}}" @else placeholder="Enter Email" @endif />
                                                        </div>
                                                    </div>
