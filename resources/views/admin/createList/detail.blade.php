            ...
            <table class="table table-striped mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex ">
                                <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2" data-bs-toggle="modal" data-bs-target="#duplicateGroup{{$val->id}}" title="Duplicate Group" role="button">
                                ...
                                {{-- <a class="btn btn-primary btn-icon text-white btn-sm rounded-pill ms-2"  title="Sync Group" role="button" href="{{url('create-list/sync/'.$val->id)}}">
                                    <span class="btn-inner">
                                        <i class="fa-solid fa-arrows-rotate"></i>
                                    </span>
                                </a> --}}
                                @if(Auth::user()->role == 1)
                                <a class="btn btn-danger btn-icon btn-sm rounded-pill ms-2" title="Delete Group" href="{{url('create-list/delete/'.$val->id)}}" role="button">
                                    <span class="btn-inner">
